Program to set up a raspberry pi pico as a server to control a rocket thrust test stand, using an hx711 ADC to read the output of a load cell and store it in an sd card. 
